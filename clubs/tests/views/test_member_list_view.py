...
class MemberListViewTestCase(TestCase):
    ...
    def test_get_member_list(self):
        self.client.login(email=self.owners.email, password="Password123")
    ...
    def test_officer_can_not_promote_member(self):
        ...
        self.assertFalse(self.member in self.club.owners.all())
    ...
    def test_owner_can_promote_member(self):
        ...
        self.client.get(self.promote_url)
        self.assertTrue(self.member in self.club.owners.all())
